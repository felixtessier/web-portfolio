...
Now that I've worked as a Software developer for a while, it's pretty safe for me to say that I'm happy that I took the plunge and made the career switch. I was honestly scared at the time, but now I get to be around technology, design and build applications for my team. I feel more like an engineering than ever and I'm really excited for what's next! So yeah, that's kind of "how I got here". It definitely didn't go according to plan (was there really ever a plan?) but things ended up working out pretty nicely.
